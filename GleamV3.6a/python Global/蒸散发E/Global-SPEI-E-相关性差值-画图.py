# -*- coding: utf-8 -*-
"""
Created on Thu Oct 13 20:54:36 2022
...
def CreatMap(data1, data2, lon, lat, levels, cmap, title):
    ...
    #ax.text(135, -140, "01~20 minus 81~00", color='dimgray', fontsize=12)
    #ax.text(130, 35, "MERRA2", color='dimgray')
    plt.suptitle(f"{title}", fontsize=20)
    #plt.savefig(rf'E:/Gleamv3.6a/v3.6a/JPG_GLOBAL/SPEI-ET相关/{title}.jpg', 
     #           bbox_inches='tight')
    plt.savefig(rf'E:/Gleamv3.6a/v3.6a/JPG_GLOBAL/SPEI-ET相关-20年差值/NEA/{title}.jpg', 
                bbox_inches='tight')
    plt.show()
...
def PLOT1(data1, data2):
    ...
    CreatMap(data1, data2, lon, lat, levels,
            cmap, title=f"81-00 SPEI-ET CORR GLEAM {mn_str[mn-1]}")
     
#%% 1981-2000
for mn in range(1, 13):
    inpath = rf"E:/Gleamv3.6a/v3.6a/global/Corr/SPEI_E_81_00_month{mn}.nc"
    read_nc(inpath)
    #PLOT1(r, p)
    
#%% 2001-2020
for mn in range(1, 13):
    inpath2 = rf"E:/Gleamv3.6a/v3.6a/global/Corr/SPEI_E_00_20_month{mn}.nc"
    read_nc2(inpath2)
    #PLOT1(r2, p2)
...
def PLOT2(data1, data2):
    ...
    CreatMap(data1, data2, lon, lat, levels,
            cmap, title=f"NEA Difference SPEI-ET CORR GLEAM {mn_str[mn-1]}")
    
    
#%% 01-20 minus 1981-2000
for mn in range(1, 13):
    inpath = rf"E:/Gleamv3.6a/v3.6a/global/Corr/SPEI_E_81_00_month{mn}.nc"
    read_nc(inpath)
    inpath2 = rf"E:/Gleamv3.6a/v3.6a/global/Corr/SPEI_E_00_20_month{mn}.nc"
    read_nc2(inpath2)
    inpath3 = rf"E:/Gleamv3.6a/v3.6a/global/Corr/SPEI_E_difference_month{mn}.nc"
    pt = read_nc3(inpath3)
    rr = r2-r
    PLOT2(rr, pt)
