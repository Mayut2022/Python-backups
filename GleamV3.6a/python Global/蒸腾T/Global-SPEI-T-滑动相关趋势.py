# -*- coding: utf-8 -*-
"""
Created on Wed Oct 12 20:44:56 2022
...
def CreatNC(data1, data2, data3, mn):
    new_NC = nc.Dataset(
        rf'E:/Gleamv3.6a/v3.6a/global/Corr/SPEI_T_81_20_MovingTrend_(n=5)_month{mn}.nc', 
        'w', format='NETCDF4')
    ...
    var.time = f"month(mn) SPEI-Et Pearson相关 n=5 滑动相关 回归趋势"
