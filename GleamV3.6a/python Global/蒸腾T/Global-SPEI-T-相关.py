# -*- coding: utf-8 -*-
"""
Created on Wed Oct 12 11:06:30 2022
...
def CreatNC(data1, data2, mn):
    new_NC = nc.Dataset(rf'E:/Gleamv3.6a/v3.6a/global/Corr/SPEI_T_81_20_month{mn}.nc', 
        'w', format='NETCDF4')
    ...
    var.description = "1981.1-2020.12 Et (TRANSPIRATION) 仅linear插值，其他未处理的标准化距平"
    var.time = f"month(mn) SPEI-T Pearson相关"
...
for mn in range(1, 13):
    inpath = rf"E:/Gleamv3.6a/v3.6a/global/Zscore/Et_1980-2021_GLEAM_v3.6a_MO_SPEI_0.5X0.5_Zscore_month{mn}.nc"
    read_nc(inpath)
...
def CreatNC2(data1, data2, mn):
    new_NC = nc.Dataset(rf'E:/Gleamv3.6a/v3.6a/global/Corr/SPEI_T_81_20_allmonth.nc', 
        'w', format='NETCDF4')
