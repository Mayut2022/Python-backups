# -*- coding: utf-8 -*-
"""
Created on Thu Oct 13 21:06:39 2022
...
def CreatMap(data1, data2, lon, lat, levels, cmap, title):
    ...
    #plt.savefig(rf'E:/Gleamv3.6a/v3.6a/JPG_GLOBAL/SPEI-ET相关/{title}.jpg', 
     #           bbox_inches='tight')
    plt.savefig(rf'E:/Gleamv3.6a/v3.6a/JPG_GLOBAL/SPEI-T相关-20年差值/{title}.jpg', 
                bbox_inches='tight')
    plt.show()
...
def PLOT1(data1, data2):
    ...
    CreatMap(data1, data2, lon, lat, levels,
            cmap, title=f"01-20 SPEI-T CORR GLEAM {mn_str[mn-1]}")
     
#%% 1981-2000
for mn in range(1, 13):
    inpath = rf"E:/Gleamv3.6a/v3.6a/global/Corr/SPEI_T_81_00_month{mn}.nc"
    read_nc(inpath)
    #PLOT1(r, p)
    
#%% 2001-2020
for mn in range(1, 13):
    inpath2 = rf"E:/Gleamv3.6a/v3.6a/global/Corr/SPEI_T_01_20_month{mn}.nc"
    read_nc2(inpath2)
    #PLOT1(r2, p2)
...
def PLOT2(data1, data2):
    ...
    CreatMap(data1, data2, lon, lat, levels,
            cmap, title=f"Difference SPEI-T CORR GLEAM {mn_str[mn-1]}")
