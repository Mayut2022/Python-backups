...
def CreatNC(yr, data):
    ...
    new_NC = nc.Dataset(
        rf"/mnt/e/GLASS-GPP/Month Global SPEI0.5x0.5/GLASS_GPP_{yr}.nc", 
        'w', format='NETCDF4')
    ...
    var.description = \
        "Units: gC m-2 month-1; FillValue: 65535, 已处理为np.nan; \
...
plt.imshow(a, cmap="Set3", origin="lower", vmax=300)
