...
def read_nc():
    global lat, lon
    inpath = (r"E:/GLASS-GPP/Month Global SPEI0.5x0.5/MG_GPP_82_18_SPEI_0.5x0.5.nc")
...
def PLOT2(data1, data2, lev):
    ...
    lev2 = lev.split('<')[1]
    # title = rf"Drought GPP (SPEI under {lev2})"
    title = rf"Non-Drought GPP (SPEI under {lev2})"
    print("\n", title)
...
# %%
lev1 = "(spei)<-0.5"
gNm1, _, _, gYc1 = gpp_drought(lev1, gpp1, spei1)
gNm2, _, _, gYc2 = gpp_drought(lev1, gpp2, spei2)


# %%
# PLOT(gYc1, gYc2, lev1)
PLOT2(gNm1, gNm2, lev1)
