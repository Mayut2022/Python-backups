...
def plot(data1, title):
    ...
    for i in range(4):
        axs[i].bar(t, data1[:, i], color='brown', alpha=0.6) #
        ...
        if i+1==1:
            ...
            axs[i].set_yticks(np.arange(10, 31, 5))
            ...
            axs[i].set_yticks(np.arange(30, 71, 10))
...
plot(sm_ave, f"MG Grassland SM Annual")
