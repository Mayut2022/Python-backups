...
def plot(data1, title):
    ...
    for i in range(4):
        ...
        axs[i].axvline(17, color="b", linewidth=2, zorder=3)
        # 渐变色柱状图
        # 归一化
