...
def plot_box(data, title):
    ...
    f = sns.violinplot(ax=ax, data=data, x="Level", y="LAI Diff", hue="State", palette=palette,
...
# plot_box(df2_plot, title=r"Violin 1999-2020")
...
# plot_box(df1_plot, title=r"Violin 1982-1998")
