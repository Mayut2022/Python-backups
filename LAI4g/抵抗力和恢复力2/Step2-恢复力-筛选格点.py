...
#%%
def one_sample_step2(df):
    threshold = df["SPEIt1"].mean()
    print(threshold)
    
    # 从干旱出发，筛选干旱
    ind1 = df["SPEIt1"] < threshold
    ind2 = df["SPEIt2"] > threshold
...
#%%
        ...
        df1982 = df[df["YEAR"]<2000]
        df2000 = df[df["YEAR"]>=2000]
#%%
        df1982_sp = one_sample_step2(df1982)
        df2000_sp = one_sample_step2(df2000)
