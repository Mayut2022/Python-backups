...
def plot_all(data1, data2, title):
    ...
    ax.axvline(90, color="b", linewidth=1, zorder=3)
    ax.text(90, 2, "1999(drought turning point)", c='b', fontsize=15)
    ...
    ax.set_title(f"1982-2020 GSL LAI&SPEI", fontsize=15, loc="left")
...
plot_all(lai_mk, spei_mk, title=r"Grassland LAI&SPEI GSL Month")
