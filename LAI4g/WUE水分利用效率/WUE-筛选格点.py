...
# # %%
data = pd.concat([lai_df2, spei_df2, spei_std_df2, wue_df2], axis=1)
data.columns = ["LAI Diff", "SPEI Diff", "SPEI Std", "WUE"]

#%% 从SPEI出发进行筛选， 筛选植被显著增长年份
df_wet = data.copy()
...
writer = pd.ExcelWriter('WUE Sample.xlsx', engine='xlsxwriter')
