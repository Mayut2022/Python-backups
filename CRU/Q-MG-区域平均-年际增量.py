...
def plot(data1, data2, title):
    ...
    for i in range(2):
        ...
        if i == 0:
            ...
            ax.set_title("WaterYield Interannual increment", loc="left", fontsize=15)
        ##########################
        elif i == 1:
            ax.text(16, 25, "1999(drought turning point)", c='k', fontsize=15)
            ax = axes[i]
...
plot(pre_ave, pre_ave, f"MG Grassland Water Yield Interannual increment")
