...
def plot(data1, data2):
    ...
    title = r"CO2-LAI PCORR(SPEI) GSL Mean"
    # title = r"SPEI-LAI PCORR(CO2) GSL Mean"
...
pr, p_val = partial_corr(spei, co2, lai)
plot(pr, p_val)

# pr2, p_val2 = partial_corr2(spei, co2, lai)
# plot(pr2, p_val2)
