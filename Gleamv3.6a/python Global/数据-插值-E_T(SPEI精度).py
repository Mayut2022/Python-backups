...
def read_nc():
    ...
    inpath = r'E:/Gleamv3.6a/Data/v3.6a monthly/E_1980-2021_GLEAM_v3.6a_MO.nc'
...
def read_nc3():
    ...
    inpath = r'E:/Gleamv3.6a/Data/v3.6a monthly/Et_1980-2021_GLEAM_v3.6a_MO.nc'
    with nc.Dataset(inpath, mode='r') as f:
...
def CreatNC(data):
    new_NC = nc.Dataset(
        r'E:/Gleamv3.6a/Data/v3.6a monthly/E_1980-2021_GLEAM_v3.6a_MO_SPEI_0.5X0.5.nc', 
        'w', format='NETCDF4')
    ...
    var.description = "1981.1-2020.12 E (actual e) 仅linear插值，其他均未处理，月平均 mm/month"
...
def CreatNC2(data):
    new_NC = nc.Dataset(
        r'E:/Gleamv3.6a/Data/v3.6a monthly/Et_1980-2021_GLEAM_v3.6a_MO_SPEI_0.5X0.5.nc', 
        'w', format='NETCDF4')
    ...
    var.description = "1981.1-2020.12 Et (蒸腾 Transpiration) 仅linear插值，其他均未处理，月平均 mm/month"
    var.time = "days since 1980-01-31 00:00:00"
    var.scalar = '将原0.25x0.25精度插值成0.5x0.5, 降尺度 与SPEI数据保持一致'
