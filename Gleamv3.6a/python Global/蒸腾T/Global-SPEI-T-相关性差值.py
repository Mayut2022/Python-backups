...
def read_nc2():
    ...
    with nc.Dataset(inpath) as f:
        ...
        spei = (f.variables['spei'][1200:])
        time = (f.variables['time'][1200:])
...
def CreatNC(data1, data2, mn):
    new_NC = nc.Dataset(rf'E:/Gleamv3.6a/v3.6a/global/Corr/SPEI_T_difference_month{mn}.nc', 
        'w', format='NETCDF4')
    ...
    var.description = "1981.1-2000.12 T 仅linear插值，其他未处理的标准化距平, 检测前后20年是否有显著差异"
...
for mn in range(2, 13):
    inpath = rf"E:/Gleamv3.6a/v3.6a/global/Zscore/T_1980-2021_GLEAM_v3.6a_MO_SPEI_0.5X0.5_Zscore_month{mn}.nc"
    read_nc(inpath)
    read_nc3(inpath)
