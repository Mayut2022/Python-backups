# -*- coding: utf-8 -*-
"""
Created on Wed Oct 12 11:15:53 2022
...
def read_nc2():
    global lat, lon, r, p
    inpath = rf'E:/Gleamv3.6a/v3.6a/global/Corr/SPEI_T_81_20_allmonth.nc'
    with nc.Dataset(inpath, mode='r') as f:
...
def PLOT1(data1, data2):
    ...
    CreatMap(data1, data2, lon, lat, levels,
            cmap, title=f"1981-2020 SPEI-T CORR GLEAM {mn_str[mn-1]}")
     
#%%
for mn in range(1, 13):
    inpath = rf"E:/Gleamv3.6a/v3.6a/global/Corr/SPEI_T_81_20_month{mn}.nc"
    read_nc(inpath)
    PLOT1(r, p)
...
def PLOT2(data1, data2):
    ...
    #CreatMap(data1, data2, lon, lat, levels,
     #       cmap, title=f"1981-2020 SPEI-T CORR GLEAM Monthall")
