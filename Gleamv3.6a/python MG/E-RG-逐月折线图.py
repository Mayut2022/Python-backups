...
def read_nc3():
    ...
    inpath = r"E:/Gleamv3.6a/Data/global/Eanom_1980-2021_GLEAM_v3.6a_MO_SPEI_0.5X0.5.nc"
    with nc.Dataset(inpath) as f:
        #print(f.variables.keys())
...
def plot(data1, data2, title):
    ...
    for i in range(4):
        for j in range(3):
            ...
            lin1 = ax2.bar(t, data2[ind, :], color='#1E90FF', label="ET", alpha=0.5) #
            ...
            ax2.tick_params(axis='y', labelsize=15, colors="#1E90FF")
    ...
    '''
    plt.ylabel("ET (mm/month)", fontsize=15)
...
plot(e_ave, eanom_ave, f"MG Grassland ET new")
