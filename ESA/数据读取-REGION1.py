# -*- coding: utf-8 -*-
"""
Created on Tue Sep 20 09:56:41 2022
...
def CreatMap(data, lon, lat, levels, cmap, labels, savename):
    ...
    # 绘制矩形图例
    rectangles = [Rectangle((0, 0,), 1, 1, facecolor=x, edgecolor="k") for x in cmap]
    labels = labels
    ax.legend(rectangles, labels,
              bbox_to_anchor=(1.2, 0.4), fancybox=True, frameon=True)
    ...
    plt.savefig(r'E:/ESA/JPG/%s.jpg' % savename, box_inches='tight')
    plt.show()
...
#%% 粗分类
df2 = pd.read_excel(r"E:/ESA/Region1 ESA LUC降尺度SPEI03.xlsx", sheet_name='LUC Class')
colors2 = df2['colors']
